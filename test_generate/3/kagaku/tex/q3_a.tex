...
\begin{enumerate}
    ...
    (A)（ \textcolor{red}{\textbf{原子核}} ）\\
    (B)（ \textcolor{red}{\textbf{陽子}} ）\\
    (C)（ \textcolor{red}{\textbf{中性子}} ）\\
    (D)（ \textcolor{red}{\textbf{電子}} ）
    \item 原子が全体として電荷を帯びていない（電気的に中性である）理由を簡潔に答えなさい。\\[0.2cm]
    理由（ \textcolor{red}{\textbf{＋の電気をもつ陽子の数と、－の電気をもつ電子の数が同じだから。}} ）
    \item 原子番号が同じで、中性子の数が異なる原子同士を互いに何というか。\\[0.2cm]
    （ \textcolor{red}{\textbf{同位体}} ）
\end{enumerate}
\end{minipage}
